...
const projects = [
  {
    id: 0,
    title: "GOSPORT – Sports Coaching Platform",
    description:
    ...
    features: [
      ...
      "Workout Builder and Workout Player",
      "Training program management",
      "Performance and body metrics tracking",
            ...
            {projects.map((project) => (
              ...
              >
                ...
                <div className="relative">
                  ...
                  />
                  {project.badge && (
                    <span className="absolute top-2 left-2 px-2 py-0.5 text-[10px] font-bold tracking-widest uppercase bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-full shadow-lg border border-purple-400/30">
                      {project.badge}
                    </span>
                  )}
                </div>
          ...
          {projects.map((project) => (
            ...
            >
              ...
              <div className="relative">
                ...
                />
                {project.badge && (
                  <span className="absolute top-3 left-3 px-2.5 py-0.5 text-[10px] font-bold tracking-widest uppercase bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-full shadow-lg border border-purple-400/30">
                    {project.badge}
                  </span>
                )}
              </div>
